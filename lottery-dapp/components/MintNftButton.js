...
export default function MintNftButton({
  ...
  return (
    <div>
      <Head></Head>
      <button
        className={isMintMartenActive ? 'pulse active' : 'pulse '}
      ...
      <div
        className={isMintMartenActive ? 'modallMINT active' : 'modallMINT'}
        onClick={() => setisMintMartenActive(false)}
      >
        <div className='areaMINT' onClick={(e) => e.stopPropagation()}>
          <div>
            <div className='imageWithArrow'>
              {arrayAllowToMint.length > 1 && (
                <div
              ...
              <div className='MINT pulse' style={{ padding: '7px' }}>
                <Image
                  src={`/imagesETH/${arrayAllowToMint[index]}.png`}
              ...
              {arrayAllowToMint.length > 1 && (
                <div
                  ...
                  onClick={() => {
                    if (index != arrayAllowToMint.length - 1) {
                      setindex(parseInt(index) + 1);
                    }
                  }}
                >
            ...
            <div className='MINT'>
              <button
                ...
                style={{ margin: '20px', width: '150px', fontSize: '20px' }}
                onClick={() => {
                  MintMarten(arrayAllowToMint[index]);
                }}
              >
                Mint
              </button>
