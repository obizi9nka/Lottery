...
export default function Wallet({
  ...
  useEffect(() => {
    checkNftButton();
    getAllNews();
    if (needCheckNFT) setneedCheckNFT(false);
        ...
        {address && (
          <div className='otstup '>
            <button
              ...
              className='mybutton size'
            >
              {' '}
              {'0x...' + address.substring(38, 42)}
            </button>
          </div>
        )}
        <WalletAlert
          ...
          settxData={settxData}
          tymblerNaNetwork={tymblerNaNetwork}
          active={isWalletAlert}
          setActive={setisWalletAlert}
          chainId={chain != undefined ? chain.id : 0}
          address={address}
        />
      </div>
                        ...
                        <div>
                          <div className='ConnectWallet'>
                            <button
                              ...
                              className={needWallet ? 'mybutton' : 'mybutton'}
                            >
                              Connect Wallet
                            </button>
                          </div>
