  ...
  if (chainId == ETHid) {
    ...
    if (players != null) {
      ...
      for (let i = 0; i < players.length; i++) {
        ...
        if (index != -1 && index != undefined) {
          AlredyNews.LobbiesETH =
            AlredyNews.LobbiesETH.substring(0, index) +
            AlredyNews.LobbiesETH.substring(
              index + `${creator}&${id}_`.length,
              AlredyNews.LobbiesETH.length
            );
        }

        let news =
          (AlredyNews.newsETH && AlredyNews.newsETH.length > 0
            ? AlredyNews.newsETH
            : '') + newNews;
        if (winer == players[i]) {
          news += '_1&';
      ...
      lobbbies =
        lobbbies.LobbiesETH != null
          ? lobbbies.LobbiesETH + `${creator}&${id}_`
          : `${creator}&${id}_`;
    ...
    if (players != null) {
      ...
      for (let i = 0; i < players.length; i++) {
        ...
        if (index != -1 && index != undefined) {
          AlredyNews.LobbiesBNB =
            AlredyNews.LobbiesBNB.substring(0, index) +
            AlredyNews.LobbiesBNB.substring(
              index + `${creator}&${id}_`.length,
              AlredyNews.LobbiesBNB.length
            );
        }

        let news =
          (AlredyNews.newsBNB && AlredyNews.newsBNB.length > 0
            ? AlredyNews.newsBNB
            : '') + newNews;
        if (winer == players[i]) {
          news += '_1&';
      ...
      lobbbies =
        lobbbies.LobbiesBNB != null
          ? lobbbies.LobbiesBNB + `${creator}&${id}_`
          : `${creator}&${id}_`;
